...
function startWinnerTimer() {
    ...
    winnerTimerInterval = setInterval(() => {
        ...
        // Убираем автоматическое закрытие модального окна после 30 секунд
        // Пользователь должен сам закрыть окно кнопкой "Закрыть"
    }, 1000);
}
...
>>>>>>> 57daa1b24864dfb5a7ce4f3f66cebcc9969304a6
